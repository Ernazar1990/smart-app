            ...
            <div className="grid grid-cols-3 gap-3">
              {['1','2','3','4','5','6','7','8','9','0'].map(d => (
                <button
                  ...
                  className="bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 rounded-2xl py-4 font-black text-xl shadow-sm"
                >
                  {d}
                </button>
              ))}
            ...
            {step === 4 && (
              <div className="space-y-4 text-center animate-in zoom-in">
                <input
                  ...
                  maxLength={4}
                  placeholder="0000"
                  className="w-40 mx-auto p-5 bg-emerald-50 rounded-[30px] text-center text-4xl font-black tracking-[0.3em] outline-none text-emerald-700 focus:border-emerald-500 transition-all font-outfit"
                  value={formData.pin}
