    ...
    <div className="space-y-6 pb-24 animate-in fade-in">
      <header className="flex justify-between items-end px-2">
        <div>
          ...
          <p className="text-gray-500 dark:text-slate-500 text-sm">Гранттар мен университеттер әлемі</p>
        </div>
        <button 
              ...
              {filteredUnis.map(uni => (
                ...
                >
                  ...
                  <div className="flex-1 space-y-1">
                    <h4 className="font-black text-gray-900 dark:text-white text-base leading-snug line-clamp-2 font-outfit">{uni.name}</h4>
                    <span className="text-[10px] font-black text-emerald-600 dark:text-emerald-400 uppercase tracking-widest">{uni.location}</span>
                  </div>
